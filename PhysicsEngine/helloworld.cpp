...
/*amespace JPH {
	static bool MyAssertFailed(const char* expr, const char* msg, const char* file, unsigned int line)
	{
		return true; // ignore asserts
	}
	bool (*AssertFailed)(const char*, const char*, const char*, unsigned int) = MyAssertFailed;
}
*/
